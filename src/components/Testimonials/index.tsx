    ...
    <section className="bg-white">
      <div className="container mx-auto py-20 px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <div className="p-4 bg-white shadow-md w-full flex flex-col">
      ...
      <div className="relative bg-testimonials bg-center h-[300px] md:h-[550px] overflow-hidden bg-cover bg-no-repeat"></div>
    </section>
  );
};
